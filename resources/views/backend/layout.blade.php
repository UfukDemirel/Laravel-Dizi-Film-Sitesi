...
<head><base href="">
    ...
    <link href="/resources2/assets/plugins/custom/fullcalendar/fullcalendar.bundle.css" rel="stylesheet" type="text/css" />
    <!--end::Page Vendors Styles-->
    <!--begin::Global Theme Styles(used by all pages)-->
    <link href="/resources2/assets/plugins/global/plugins.bundle.css" rel="stylesheet" type="text/css" />
    <link href="/resources2/assets/plugins/custom/prismjs/prismjs.bundle.css" rel="stylesheet" type="text/css" />
    <link href="/resources2/assets/css/style.bundle.css" rel="stylesheet" type="text/css" />
    <!--end::Global Theme Styles-->
    <!--begin::Layout Themes(used by all pages)-->
    <link href="/resources2/assets/css/themes/layout/header/base/light.css" rel="stylesheet" type="text/css" />
    <link href="/resources2/assets/css/themes/layout/header/menu/light.css" rel="stylesheet" type="text/css" />
    <link href="/resources2/assets/css/themes/layout/brand/dark.css" rel="stylesheet" type="text/css" />
    <link href="/resources2/assets/css/themes/layout/aside/dark.css" rel="stylesheet" type="text/css" />
    <!--end::Layout Themes-->
    <link rel="shortcut icon" href="/resources2/assets/media/logos/logo-1.svg" />
</head>
...
<div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
    <!--begin::Logo-->
    <a href="{{route('index')}}">
        <img alt="Logo" src="/resources2/assets/media/logos/logo-1.svg" />
    </a>
    <!--end::Logo-->
    <!--begin::Toolbar-->
        ...
        <div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
            ...
            <div class="brand flex-column-auto" id="kt_brand">
                ...
                <a href="{{route('index')}}" class="brand-logo">
                    <img alt="Logo" src="/resources2/assets/media/logos/logo-1.svg" class="h-30px" />
                </a>
                <!--end::Logo-->
                <!--begin::Toggle-->
                ...
                <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
                    ...
                    <ul class="menu-nav">
                        ...
                        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                            <a href="{{route('filmler')}}" class="menu-link menu-toggle">
										<span class="svg-icon menu-icon">
                                ...
                                <span class="menu-text">FİLMLER</span>
                            </a>
                        </li>
                        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                            <a href="{{route('diziler')}}" class="menu-link menu-toggle">
										<span class="svg-icon menu-icon">
											<!--begin::Svg Icon | path:assets/media/svg/icons/Layout/Layout-arrange.svg-->
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
												<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                ...
                                <span class="menu-text">DİZİLER</span>
                            </a>
                        </li>
                        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                            <a href="" class="menu-link menu-toggle">
                                ...
                                <span class="menu-text">OYUNCULAR</span>
                            </a>
                        </li>
                    </ul>
                    <!--end::Menu Nav-->
                                        ...
                                        <ul class="menu-subnav">
                                            <li class="menu-item menu-item-active" aria-haspopup="true">
                                                <a href="index.html" class="menu-link">
                                                    ...
                                                    <span class="menu-text">Profilimi Düzenle</span>
                                                </a>
                                            </li>
                    ...
                    <div class="topbar">
                        ...
                        <div class="topbar-item ml-4">
                            <div class="btn btn-icon btn-light-primary h-40px w-40px p-0" id="kt_quick_user_toggle">
                                <img src="/resources2/assets/media/svg/avatars/004-boy-1.svg" class="h-30px align-self-end" alt="" />
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="navi navi-spacer-x-0 p-0">
            <a href="custom/apps/user/profile-1/personal-information.html" class="navi-item">
                <div class="navi-link">
                    ...
                    <div class="navi-text">
                        <div class="font-weight-bold">Profilimi Düzenle</div>
            ...
            <span class="navi-item mt-2">
						<span class="navi-link">
							<a href="{{route('logout')}}" class="btn btn-sm btn-light-primary font-weight-bolder py-3 px-6">Çıkış</a>
						</span>
            </span>
        </div>
...
<script src="/resources2/assets/plugins/global/plugins.bundle.js"></script>
<script src="/resources2/assets/plugins/custom/prismjs/prismjs.bundle.js"></script>
<script src="/resources2/assets/js/scripts.bundle.js"></script>
<!--end::Global Theme Bundle-->
<!--begin::Page Vendors(used by this page)-->
<script src="/resources2/assets/plugins/custom/fullcalendar/fullcalendar.bundle.js"></script>
<!--end::Page Vendors-->
<!--begin::Page Scripts(used by this page)-->
<script src="/resources2/assets/js/pages/widgets.js"></script>
